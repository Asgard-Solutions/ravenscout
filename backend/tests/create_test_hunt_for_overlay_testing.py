...
BASE_URL = "https://tactical-auth-hub.preview.emergentagent.com"
...
if response.status_code == 200:
    ...
    if data["success"]:
        ...
        print(f"Navigate to: https://tactical-auth-hub.preview.emergentagent.com/results?huntId={hunt_id}")
