...
BASE_URL = "https://panorama-memory-fix.preview.emergentagent.com"
...
if response.status_code == 200:
    ...
    if data["success"]:
        ...
        print(f"Navigate to: https://panorama-memory-fix.preview.emergentagent.com/results?huntId={hunt_id}")
