...
BASE_URL = "https://hunt-analysis-pro.preview.emergentagent.com"
...
if response.status_code == 200:
    ...
    if data["success"]:
        ...
        print(f"Navigate to: https://hunt-analysis-pro.preview.emergentagent.com/results?huntId={hunt_id}")
