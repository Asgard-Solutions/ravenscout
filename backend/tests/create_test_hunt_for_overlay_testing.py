...
BASE_URL = "https://tactical-media-v3.preview.emergentagent.com"
...
if response.status_code == 200:
    ...
    if data["success"]:
        ...
        print(f"Navigate to: https://tactical-media-v3.preview.emergentagent.com/results?huntId={hunt_id}")
