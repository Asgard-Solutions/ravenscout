...
BASE_URL = "https://tactical-overlay-2.preview.emergentagent.com"
...
if response.status_code == 200:
    ...
    if data["success"]:
        ...
        print(f"Navigate to: https://tactical-overlay-2.preview.emergentagent.com/results?huntId={hunt_id}")
