...
- Subscriptions auto-renew; cancel any time in your store account.
- Refunds follow Apple / Google policy — see our [Refund Policy](raven-scout-refund-policy.md).

## Liability Limits (the hunting-specific bit)
- The AI output is a suggestion, not a guarantee. Stand placements, wind predictions, and access routes are **starting points** — you must verify every recommendation on the ground.
- Raven Scout is not liable for:
  - Missed shots, unsuccessful hunts, wounded or unrecovered game.
